...
from pkg.utils.grad_cam import compile_gradient_function
from pkg.utils.grad_cam import compile_saliency_function
from pkg.utils.grad_cam import register_gradient
from pkg.utils.grad_cam import modify_backprop
from pkg.utils.grad_cam import calculate_guided_gradient_CAM
from pkg.utils.datasets import get_labels
from pkg.utils.inference import detect_faces
from pkg.utils.inference import apply_offsets
from pkg.utils.inference import load_detection_model
from pkg.utils.preprocessor import preprocess_input
from pkg.utils.inference import draw_bounding_box
from pkg.utils.inference import load_image
...
if task == 'emotion':
    ...
    offsets = (0, 0)
    # model_filename = '../data/trained_models/fer2013_big_XCEPTION.54-0.66.hdf5'
    model_filename = '../data/trained_models/emotion_models/fer2013_mini_XCEPTION.102-0.66.hdf5'
elif task == 'gender':
    labels = get_labels('imdb')
    offsets = (30, 60)
    model_filename = '../data/trained_models/gender_models/gender_mini_XCEPTION.21-0.95.hdf5'
...
cv2.imwrite('../data/images/guided_gradCAM.png', bgr_image)
