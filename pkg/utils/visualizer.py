...
def build_report_image(seconds: np.array, distributions: np.array, labels: list, path: str,
                       figsize=None, fontsize=60, linewidth=4, gridwidth=6):

    figsize = (50, 25) if figsize is None else figsize
    plt.figure(figsize=figsize)
    plt.plot(np.array(seconds), np.array(distributions), linewidth=linewidth)
